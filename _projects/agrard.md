---
title: Plataformas de datos geoespaciales listos para el análisis en dominios específicos para acelerar la transformación digital del sector agrario<br><em>Domain-specific analysis-ready geospatial data platforms to accelerate the digital transformation of the agricultural sector</em>
acron: AGRARD
code: PID2024-155657OB-C21, PID2024-155657OB-C22
keywords: Analasys-Ready, Geospatial Data, Agricultural Sector, Earth Observation, DGGS, Discrete Global Grid Systems, Compact Data Structures, CDS, Integrated Data Platforms, FAIR, Big Geodata, Data Spaces, Data Cubes. 
years: 2025-2028
...
<img src='{{site.baseurl}}/images/other-logos/MICIU+Cofinanciado+AEI.jpg' width='600' style="margin-bottom: 40px;">
